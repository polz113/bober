...
urlpatterns = [
    ...
    url(r'^competition/(?P<username>[^/]*)/potrdilo.pdf$', 
        views.mentor_certificate_pdf, name="mentor_certificate_pdf"),
    url(r'^competition/(?P<slug>[\w\-_]+)/award/(?P<username>[^/]*)/(?P<school_id>\d+)/(?P<cqs_name>.*).pdf$', 
        views.school_awards_pdf, name="school_awards_pdf"),
    url(r'^competition/(?P<slug>[\w\-_]+)/award/(?P<username>[^/]*)/(?P<cqs_name>.*).pdf$', 
