...
urlpatterns = [
    ...
    path(r'competition/<slug:slug>/award/<str:username>/by_school/<int:school_id>/<int:cqs_id>-<str:cert_basename>.pdf',
        views.school_awards_pdf, name="awards_school_pdf"),
    path(r'competition/<slug:slug>/award/<str:username>/by_school/<int:school_id>/<str:award_name>/<int:cqs_id>-<str:cert_basename>.pdf',
        views.awards_school_type_pdf, name="awards_school_type_pdf"),
    path(r'competition/<slug:slug>/award/<str:username>/all/<int:cqs_id>-<str:cert_basename>.pdf',
        views.all_awards_pdf, name="awards_all_pdf"),
    path(r'competition/<slug:slug>/award/<str:username>/by_type/<str:award_name>/<int:cqs_id>-<str:cert_basename>.pdf',
