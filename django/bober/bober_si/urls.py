...
urlpatterns = [
    ...
    path(r'competition/<slug:slug>/award/<str:username>/all/<int:cqs_id>-<str:cqs_slug>.pdf',
        views.all_awards_pdf, name="awards_all_pdf"),
    path(r'competition/<slug:slug>/award/<str:username>/by_type/<str:award_name>/<int:cqs_id>-<str:cqs_slug>.pdf',
