...
class TaskTable(tables.Table):
    ...
    export = tables.TemplateColumn('<input type="checkbox" name="taskValues" value="{{ record.pk }}" />', verbose_name=_('Export'), orderable=False)
    #export = tables.CheckBoxColumn(accessor="pk", verbose_name=_('Export'), orderable=False)
    class Meta:
