...
urlpatterns = [
    ...
    url(r'^profile/(?P<pk>\d+)/update$', views.ProfileUpdate.as_view(),
        name="profile_update"),
    url(r'^profile/(?P<pk>\d+)/merge$', views.ProfileMerge.as_view(),
        name="profile_merge"),
    #   5.3 get certificates, other files
    url(r'^profile/(?P<pk>\d+)/files/(?P<resource_path>)$',
    ...
    url(r'^question/(?P<pk>\d+)/$', views.QuestionDetail.as_view(),
        name="question_index"),
    url(r'^question/(?P<pk>\d+)/resources/(?P<resource_path>.*)$',
        views.question_resources, name="question_resource"),
    url(r'^question/(?P<pk>\d+)/solution/$', views.QuestionSolution.as_view(),
        name="question_solution"),
    url(r'^question/(?P<pk>\d+)/solution/(?P<resource_path>.*)$',
        views.question_resources, name="question_solution_resource"),
    # 7. create questionset from questions
    url(r'^questionset/id=$', views.QuestionSetList.as_view(),
    ...
    url(r'^code_format/competitor/(?P<pk>\d+)$',
    ...
    url(r'^code_format/competitor/create$',
