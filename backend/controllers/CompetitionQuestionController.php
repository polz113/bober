...
class CompetitionQuestionController extends Controller {
    ...
    public function actionCreate() {
        if ($this->CanAccess('create')) {
            $model = new CompetitionQuestion;

            // Uncomment the following line if AJAX validation is needed
            // $this->performAjaxValidation($model);

            if (isset($_POST['CompetitionQuestion'])) {
                $model->attributes = $_POST['CompetitionQuestion'];
    ...
    public function actionAdmin() {
        if ($this->CanAccess("admin")) {
            $model = new CompetitionQuestion('search');
            $model->unsetAttributes();  // clear any default values

            if (isset($_GET['CompetitionQuestion'])) {
                $model->attributes = $_GET['CompetitionQuestion'];
            }
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'competition-question-form') {
