...
class CountryAdministratorController extends Controller
{
	/**
	...
	public function actionCreate()
	{
        ...
        {
            $model = new CountryAdministrator;

            // Uncomment the following line if AJAX validation is needed
            // $this->performAjaxValidation($model);

            if (isset($_POST['CountryAdministrator']))
            {
                $model->attributes = $_POST['CountryAdministrator'];
	...
	public function actionAdmin()
	{
        ...
        {
            $model = new CountryAdministrator('search');
            $model->unsetAttributes();  // clear any default values

            if (isset($_GET['CountryAdministrator']))
            {
                $model->attributes = $_GET['CountryAdministrator'];
            }
	...
	{
		if (isset($_POST['ajax']) && $_POST['ajax'] === 'country-administrator-form')
		{
