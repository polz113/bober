...
class SchoolMentorConfirmationController extends Controller
{
	/**
	...
	public function actionCreate()
	{
        ...
        {
            $model = new SchoolMentorConfirmation;

            // Uncomment the following line if AJAX validation is needed
            // $this->performAjaxValidation($model);

            if (isset($_POST['SchoolMentorConfirmation']))
            {
                $model->attributes = $_POST['SchoolMentorConfirmation'];
	...
	public function actionAdmin()
	{
        ...
        {
            $model = new SchoolMentorConfirmation('search');
            $model->unsetAttributes();  // clear any default values

            if (isset($_GET['SchoolMentorConfirmation']))
            {
                $model->attributes = $_GET['SchoolMentorConfirmation'];
            }
    ...
    public function actionActivate($id)
    {
        ...
        if ($this->CanAccess('activate') && $model->CanActivate())
        {
            $model->active = 1;
	...
	{
		$model = SchoolMentorConfirmation::model()->findByPk($id);
	...
	{
		if (isset($_POST['ajax']) && $_POST['ajax'] === 'school-mentor-confirmation-form')
		{
