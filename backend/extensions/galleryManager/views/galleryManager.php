...
<hr/>
<div class="sorter">
    <div class="images" class="lightboxContainer">
        <?php foreach ($this->gallery->galleryPhotos as $photo): ?>
            <div id="<?php echo $this->id . '-' . $photo->id ?>" class="photo">
                ...
                <a href="<?php echo $photo->getPreview(''); ?>" class="lightbox" style="padding-left: 75px; position: relative;"><img style="padding-top: 5px; width: 16px; height: 16px;" src="/images/zoom_in.png" width="16" height="16" alt="+" /></a>
            </div>
        <?php endforeach; ?>
    </div>
    <br style="clear: both;"/>
...
<script type="text/javascript">
    jQuery(function() {
        jQuery('.sorter .images a.lightbox').lightBox();
    });
</script>
