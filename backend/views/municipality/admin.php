...
<h1><?php echo Yii::t('app', 'Manage Municipalities');?></h1>
    ...
    array(
        ...
        'buttons' => array(
            'active' => array(
                ...
                'label' => Yii::t('app', 'municipality_activated_click_to_deactivate'),
                'url' => 'Yii::app()->createUrl("/municipality/deactivate", array("id" => $data->id))'
            ),
            'inactive' => array(
                'visible' => '$data->active == 0',
                'imageUrl' => Yii::app()->theme->baseUrl.'/img/inactive.png',
                'options' => array('class' => 'activate'),
                'label' => Yii::t('app', 'municipality_deactivated_click_to_activate'),
                'url' => 'Yii::app()->createUrl("/municipality/activate", array("id" => $data->id))'
            ),
