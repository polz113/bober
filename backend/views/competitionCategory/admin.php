...
<h1><?php echo Yii::t('app', 'Manage Competition Categories');?></h1>
    ...
    array(
        ...
        'buttons' => array(
            'active' => array(
                ...
                'label' => Yii::t('app', 'competitionCategory_activated_click_to_deactivate'),
                'url' => 'Yii::app()->createUrl("/competitionCategory/deactivate", array("id" => $data->id))'
            ),
            'inactive' => array(
                'visible' => '$data->active == 0',
                'imageUrl' => Yii::app()->theme->baseUrl.'/img/inactive.png',
                'options' => array('class' => 'activate'),
                'label' => Yii::t('app', 'competitionCategory_deactivated_click_to_activate'),
                'url' => 'Yii::app()->createUrl("/competitionCategory/activate", array("id" => $data->id))'
            ),
...
$lastColumns = array(
		'name',
                array(
                    ...
                    'filter'=>CHtml::dropDownList('CompetitionCategory[level_of_education]', $model->level_of_education, $model->GetLevelsOfEducation(true))
                ),
		'class_from',
		'class_to',
                array(
