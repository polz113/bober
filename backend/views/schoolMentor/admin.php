...
<h1><?php echo Yii::t('app', 'Manage School Mentors'); ?></h1>
...
$firstColumns = array(
        /*
          ...
          'label' => Yii::t('app', 'schoolMentor_activated_click_to_deactivate'),
          'url' => 'Yii::app()->createUrl("/schoolMentor/deactivate", array("id" => $data->id))'
          ),
          'inactive' => array(
          'visible' => '$data->active == 0',
          'imageUrl' => Yii::app()->theme->baseUrl.'/img/inactive.png',
          'options' => array('class' => 'activate'),
          'label' => Yii::t('app', 'schoolMentor_deactivated_click_to_activate'),
          'url' => 'Yii::app()->createUrl("/schoolMentor/activate", array("id" => $data->id))'
          ),
...
$lastColumns = array(
    array(
        ...
        'value' => '$data->GetSchoolName($data->school_id)',
    ),
    array(
        'name' => 'mentor_name',
        'header' => Yii::t('app', 'Mentor'),
        'value' => '$data->GetTeacherName($data->user_id)',
    ),
    array(
        'name' => 'active',
        'header' => Yii::t('app', 'Active'),
        'value' => '$data->active == 1 ? "'.Yii::t('app', 'yes').'" : "'.Yii::t('app', 'no').'"',
    ),
    array(
        'name' => 'coordinator',
        'header' => Yii::t('app', 'Coordinator'),
        'value' => '$data->coordinator == 1 ? "'.Yii::t('app', 'yes').'" : "'.Yii::t('app', 'no').'"',
    ),
    'activated_timestamp',
    /*
      'coordinator',
