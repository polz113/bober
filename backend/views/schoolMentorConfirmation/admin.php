...
<h1><?php echo Yii::t('app', 'Manage School Mentor Confirmations');?></h1>
    ...
    array(
        ...
        'buttons' => array(
            'active' => array(
                ...
                'label' => Yii::t('app', 'schoolMentorConfirmation_activated_click_to_deactivate'),
                'url' => 'Yii::app()->createUrl("/schoolMentorConfirmation/deactivate", array("id" => $data->id))'
            ),
            'inactive' => array(
                'visible' => '$data->active == 0',
                'imageUrl' => Yii::app()->theme->baseUrl.'/img/inactive.png',
                'options' => array('class' => 'activate'),
                'label' => Yii::t('app', 'schoolMentorConfirmation_deactivated_click_to_activate'),
                'url' => 'Yii::app()->createUrl("/schoolMentorConfirmation/activate", array("id" => $data->id))'
            ),
