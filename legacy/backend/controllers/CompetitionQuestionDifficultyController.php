...
class CompetitionQuestionDifficultyController extends Controller
{
	/**
	...
	public function actionCreate()
	{
        ...
        {
            $model = new CompetitionQuestionDifficulty;

            // Uncomment the following line if AJAX validation is needed
            // $this->performAjaxValidation($model);

            if (isset($_POST['CompetitionQuestionDifficulty']))
            {
                $model->attributes = $_POST['CompetitionQuestionDifficulty'];
	...
	public function actionAdmin()
	{
        ...
        {
            $model = new CompetitionQuestionDifficulty('search');
            $model->unsetAttributes();  // clear any default values

            if (isset($_GET['CompetitionQuestionDifficulty']))
            {
                $model->attributes = $_GET['CompetitionQuestionDifficulty'];
            }
	...
	{
		if (isset($_POST['ajax']) && $_POST['ajax'] === 'competition-question-difficulty-form')
		{
