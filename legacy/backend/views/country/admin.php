    ...
    array(
        ...
        'buttons' => array(
            'active' => array(
                ...
                'label' => Yii::t('app', 'country_activated_click_to_deactivate'),
                'url' => 'Yii::app()->createUrl("/country/deactivate", array("id" => $data->id))'
            ),
            'inactive' => array(
                'visible' => '$data->active == 0',
                'imageUrl' => Yii::app()->theme->baseUrl.'/img/inactive.png',
                'options' => array('class' => 'activate'),
                'label' => Yii::t('app', 'country_deactivated_click_to_activate'),
                'url' => 'Yii::app()->createUrl("/country/activate", array("id" => $data->id))'
            ),
