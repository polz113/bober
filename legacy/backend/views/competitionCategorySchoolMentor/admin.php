...
<h1><?php echo Yii::t('app', 'All Competitors Registrations'); ?></h1>
...
$firstColumns = array(
        /*
          ...
          'label' => Yii::t('app', 'competitionCategorySchoolMentor_activated_click_to_deactivate'),
          'url' => 'Yii::app()->createUrl("/competitionCategorySchoolMentor/deactivate", array("id" => $data->id))'
          ),
          'inactive' => array(
          'visible' => '$data->active == 0',
          'imageUrl' => Yii::app()->theme->baseUrl.'/img/inactive.png',
          'options' => array('class' => 'activate'),
          'label' => Yii::t('app', 'competitionCategorySchoolMentor_deactivated_click_to_activate'),
          'url' => 'Yii::app()->createUrl("/competitionCategorySchoolMentor/activate", array("id" => $data->id))'
          ),
...
$lastColumns = array(
    ...
    array(
        'name' => 'competition_school_search',
        'header' => Yii::t('app', 'Competition - Category - School'),
        'value' => '$data->GetCompetitionCategorySchool()',
    ),
    array(
        'name' => 'user_search',
        'header' => Yii::t('app', 'Surname And Name'),
        'value' => '$data->user->profile->GetLastAndFirstName()',
    ),
    'access_code',
    'disqualified',
    'disqualified_by',
