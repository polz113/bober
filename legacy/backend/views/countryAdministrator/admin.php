...
<h1><?php echo Yii::t('app', 'Manage Country Administrators');?></h1>
    ...
    array(
        ...
        'buttons' => array(
            'active' => array(
                ...
                'label' => Yii::t('app', 'countryAdministrator_activated_click_to_deactivate'),
                'url' => 'Yii::app()->createUrl("/countryAdministrator/deactivate", array("id" => $data->id))'
            ),
            'inactive' => array(
                'visible' => '$data->active == 0',
                'imageUrl' => Yii::app()->theme->baseUrl.'/img/inactive.png',
                'options' => array('class' => 'activate'),
                'label' => Yii::t('app', 'countryAdministrator_deactivated_click_to_activate'),
                'url' => 'Yii::app()->createUrl("/countryAdministrator/activate", array("id" => $data->id))'
            ),
