...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        function t(n) {
            ...
            function E(e) {
                ...
                for (o = C(M[V], M[z]), a = M[q] - M[z]; o && a > 0;)s = o.nextSibling, l = L(o, e), t && t.appendChild(l), --a, o = s;
                return e != O && M.collapse(F), t
            }

            function S(e, t) {
                var n, i, o, a, s, l;
                if (t != I && (n = r()), i = R(e, t), n && n.appendChild(i), o = j(e), a = o - M[z], 0 >= a)return t != O && (M.setEndBefore(e), M.collapse(W)), n;
            ...
            r = r || {}, r.validate = "validate"in r ? r.validate : !0, r.root_name = r.root_name || "body", u.schema = l = l || new t, u.filterNode = function (e) {
                ...
                if (o = o || {}, p = {}, h = {}, T = s(i("script,style,head,html,body,title,meta,param"), l.getBlockElements()), O = l.getNonEmptyElements(), P = l.children, k = r.validate, I = "forced_root_block"in o ? o.forced_root_block : r.forced_root_block, D = l.getWhiteSpaceElements(), R = /^[ \t\r\n]+/, L = /[ \t\r\n]+$/, H = /[ \t\r\n]+/g, M = /^[ \t\r\n]+$/, v = new n({validate: k, self_closing_elements: g(l.getSelfClosingElements()), cdata: function (e) {
                    ...
                    if (r = k ? l.getElementRule(t) : {}) {
                        ...
                        if (B && D[t] && (B = !1), (r.removeEmpty || r.paddEmpty) && b.isEmpty(O))if (r.paddEmpty)b.empty().append(new e("#text", "3")).value = "\xa0"; else if (!b.attributes.map.name && !b.attributes.map.id)return a = b.parent, b.empty().remove(), b = a, void 0;
                        b = b.parent
                    }
        ...
        return function (r, i) {
            ...
            function c() {
                ...
                for (e in w)t = y.get("mceResizeHandle" + e), t && (y.unbind(t), y.remove(t))
            }
            ...
            function p(e) {
                ...
                for (r in w)if (o = w[r], a = t.offsetWidth * o[0], s = t.offsetHeight * o[1], Math.abs(a - c) < 8 && Math.abs(s - u) < 8) {
                    _ = o;
                    break
                }
            ...
            return i.contentStyles.push(O + " div.mce-resizehandle {" + "position: absolute;" + "border: 1px solid black;" + "background: #FFF;" + "width: 5px;" + "height: 5px;" + "z-index: 10000" + "}" + O + " .mce-resizehandle:hover {" + "background: #000" + "}" + O + " img[data-mce-selected], hr[data-mce-selected] {" + "outline: 1px solid black;" + "resize: none" + "}" + O + " .mce-clonedresizable {" + "position: absolute;" + (n.gecko ? "" : "outline: 1px dashed black;") + "opacity: .5;" + "filter: alpha(opacity=50);" + "z-index: 10000" + "}"), i.on("init", function () {
                if (P)i.on("ObjectResized", function (e) {
                    "TABLE" != e.target.nodeName && (c(), g(e.target))
                }), d(i.getBody(), "controlselect", h); else try {
    ...
    }), r(R, [d, S, T, m, f], function (e, n, r, i, o) {
        function a(e, t, i, o) {
            var a = this;
        ...
        return function (r) {
            ...
            function s() {
                ...
                ]}), Z("p h1 h2 h3 h4 h5 h6 div address pre div dt dd samp".split(/\s/), function (e) {
            ...
            function p(t, n, o) {
                ...
                function d(e, r, o) {
                    ...
                    c = m.inline || m.block, d = O.create(c), s(d), F.walk(e, function (e) {
                        ...
                        function t(e) {
                            var n, r, i;
                            if ("A" === e.nodeName) {
                                for (r = O.clone(d, j), l.push(r), i = et(e.childNodes), n = 0; n < i.length; n++)r.appendChild(i[n]);
                                e.appendChild(r)
                            }
                            Z(et(e.childNodes), t)
                        }
                        ...
                        var o;
                        if (o = r(e), (l.length > 1 || !z(e)) && 0 === o)return O.remove(e, 1), void 0;
                        if (m.inline || m.wrapper) {
                            ...
                            }), g(e.parentNode, t, n))return O.remove(e, 1), e = 0, K;
                ...
                if (m)if (o)o.nodeType ? (y = O.createRng(), y.setStartBefore(o), y.setEndAfter(o), d(k(y, h), null, !0)) : d(o, null, !0); else if (b && m.inline && !O.select("td.mce-item-selected,th.mce-item-selected").length)M("apply", t, n); else {
            ...
            function h(e, t, n) {
                function i(e) {
                    var n, r, o, a, s;
                    if (1 === e.nodeType && X(e) && (a = b, b = "true" === X(e), s = !0), n = et(e.childNodes), b && !s)for (r = 0, o = p.length; o > r && !T(p[r], t, e, e); r++);
                    if (h.deep && n.length) {
                ...
                function s(e, n, r, i) {
                    ...
                    if (e) {
                        for (u = e.parentNode, o = n.parentNode; o && o != u; o = o.parentNode) {
                            for (a = O.clone(o, j), c = 0; c < p.length; c++)if (T(p[c], t, a, a)) {
                                a = 0;
                                break
                            }
                ...
                function i(e, t, i) {
                    ...
                    if (s)if (s.length === Y) {
                        for (o in s)if (s.hasOwnProperty(o)) {
                            if (a = "attributes" === i ? O.getAttrib(e, o) : _(e, o), r && !a && !t.exact)return;
                            if ((!r || t.exact) && !w(a, N(s[o], n)))return
                        }
                    } else for (l = 0; l < s.length; l++)if ("attributes" === i ? O.getAttrib(e, s[l]) : _(e, s[l]))return t;
                    return t
                }

                var o = c(t), a, s, l;
                if (o && e)for (s = 0; s < o.length; s++)if (a = o[s], x(e, a) && i(e, a, "attributes") && i(e, a, "styles")) {
                    if (l = a.classes)for (s = 0; s < l.length; s++)if (!O.hasClass(e, l[s]))return;
                    return a
                }
            }
            ...
            function b(e) {
                var t = c(e), n, r, i, a, s;
                if (t)for (n = I.getStart(), r = o(n), a = t.length - 1; a >= 0; a--) {
                    if (s = t[a].selector, !s)return K;
                    for (i = r.length - 1; i >= 0; i--)if (O.is(r[i], s))return K
                }
                return j
            }
            ...
            function k(t, n, a) {
                function s(e) {
                    ...
                    var r, i, o, a, s;
                    if (r = i = e ? g : y, a = e ? "previousSibling" : "nextSibling", s = O.getRoot(), 3 == r.nodeType && !E(r) && (e ? v > 0 : b < r.nodeValue.length))return r;
                    for (; ;) {
                        if (!n[0].block_expand && z(i))return i;
                        for (o = i[a]; o; o = o[a])if (!B(o) && !E(o) && !t(o))return i;
                        if (i.parentNode == s) {
                            r = i;
                            break
                        }
                ...
                function c(e) {
                    for (var t = e; t;) {
                        if (1 === t.nodeType && X(t))return"false" === X(t) ? t : e;
                        t = t.parentNode
                    }
                    return e
                }
                ...
                function u(t, n, i) {
                    ...
                    for (s = new e(t, O.getParent(t, z) || r.getBody()); l = s[i ? "prev" : "next"]();)if (3 === l.nodeType) {
                ...
                function d(e, r) {
                    var i, a, s, l;
                    for (3 == e.nodeType && 0 === e.nodeValue.length && e[r] && (e = e[r]), i = o(e), a = 0; a < i.length; a++)for (s = 0; s < n.length; s++)if (l = n[s], !("collapsed"in l && l.collapsed !== t.collapsed) && O.is(i[a], l.selector))return i[a];
                    return e
                }

                function f(e, t) {
                    var r;
                    if (n[0].wrapper || (r = O.getParent(e, n[0].block)), r || (r = O.getParent(3 == e.nodeType ? e.parentNode : e, i)), r && n[0].wrapper && (r = o(r, "ul,ol").reverse()[0] || r), !r)for (r = e; r[t] && !z(r[t]) && (r = r[t], !w(r, "br")););
                    return r || e
                }
            ...
            function T(e, t, n, r) {
                var i, o, a;
                if (!x(n, e))return j;
                if ("all" != e.remove)for (Z(e.styles, function (e, i) {
                    ...
                    if (e = N(e, t), "number" == typeof i && (i = e, r = 0), !r || w(O.getAttrib(r, i), e)) {
                        if ("class" == i && (e = O.getAttrib(n, i), e && (o = "", Z(e.split(/\s+/), function (e) {
                            /mce\w+/.test(e) && (o += (o ? " " : "") + e)
                        }), o)))return O.setAttrib(n, i, o), void 0;
                ...
                }), o = O.getAttribs(n), i = 0; i < o.length; i++)if (0 !== o[i].nodeName.indexOf("_"))return j;
                ...
                function n(e, t) {
                    ...
                    function r(e, t) {
                        ...
                        for (r in e)if (e.hasOwnProperty(r)) {
                            if (n = t[r], n === Y)return j;
                            if (e[r] != n)return j;
                            delete t[r]
                        }
                        for (r in t)if (t.hasOwnProperty(r))return j;
                        return K
                    }
            ...
            function M(t, n, i) {
                ...
                function u(e, t) {
                    var n, r;
                    if (e)r = I.getRng(!0), a(e) ? (t !== !1 && (r.setStartBefore(e), r.setEndBefore(e)), O.remove(e)) : (n = l(e), n.nodeValue.charAt(0) === q && (n = n.deleteData(0, 1)), O.remove(e, 1)), I.setRng(r); else if (e = s(I.getStart()), !e)for (; e = O.get(v);)u(e, !1)
                }
                ...
                function f() {
                    ...
                    if (u)if (s)a = I.getBookmark(), e.collapse(!0), e = k(e, c(n), !0), e = F.split(e), h(n, i, e), I.moveToBookmark(a); else {
                        for (p = o(), l = p, f = d.length - 1; f >= 0; f--)l.appendChild(O.clone(d[f], !1)), l = l.firstChild;
                ...
                r._hasCaretEvents || (Q = function () {
                    var e = [], t;
                    if (a(s(I.getStart()), e))for (t = e.length; t--;)O.setAttrib(e[t], "data-mce-bogus", "1")
                }, J = function (e) {
                    var t = e.keyCode;
            ...
            function D(t) {
                ...
                if (3 == n.nodeType && r >= n.nodeValue.length && (r = U(n), n = n.parentNode, i = !0), 1 == n.nodeType)for (s = n.childNodes, n = s[Math.min(r, s.length - 1)], o = new e(n, O.getParent(n, O.isBlock)), (r > s.length - 1 || i) && o.next(), a = o.current(); a; a = o.next())if (3 == a.nodeType && !E(a))return l = O.create("a", null, q), a.parentNode.insertBefore(l, a), t.setStart(a, 0), I.setRng(t), O.remove(l), void 0
            }
    ...
    }), r(J, [Y, j, W, X, q], function (e, t, n, r, i) {
    ...
    }), r(et, [k, A, b, h, m, f], function (e, t, n, r, i, o) {
        return function (a) {
            function s(e, t) {
                try {
        ...
        var c = n.DOM, u = o.explode, d = o.each, f = o.extend, p = 0, h, m = {majorVersion: "4", minorVersion: "0b3", releaseDate: "2013-05-15", editors: [], i18n: s, activeEditor: null, setup: function () {
            ...
            for (delete r[e.id], n = 0; n < r.length; n++)if (r[n] == e) {
                r.splice(n, 1);
                break
            }
    ...
    }), r(Ht, [V, z, Y, f, at], function (e, t, n, r, i) {
        function o(e) {
            function t(e) {
        ...
        var i = e.extend({init: function (e) {
            ...
            var t = this, n, r;
            if (t._rendered)for (r = t.getEl("open").childNodes, n = 0; n < r.length; n++)3 == r[n].nodeType && (r[n].data = t.encode(e));
    ...
    }), a([l, c, u, d, f, p, h, m, g, v, y, b, C, x, w, _, N, E, S, k, T, R, A, B, L, H, M, D, P, O, I, F, W, z, V, U, q, $, j, K, G, Y, X, J, Q, Z, et, tt, nt, rt, it, ot, at, st, lt, ct, ut, dt, ft, pt, ht, mt, gt, vt, yt, bt, Ct, xt, wt, _t, Nt, Et, St, kt, Tt, Rt, At, Bt, Lt, Ht, Mt, Dt, Pt, Ot, It, Ft, Wt, zt, Vt, Ut, qt, $t, jt, Kt, Gt, Yt, Xt])
}(this);